function __wbg_get_imports() {
    const import0 = {
        ...
        __wbindgen_cast_0000000000000004: function(arg0, arg1) {
            // Cast intrinsic for `Closure(Closure { owned: true, function: Function { arguments: [], shim_idx: 577, ret: Result(Unit), inner_ret: Some(Result(Unit)) }, mutable: true }) -> Externref`.
    ...
    return {
        __proto__: null,
        "./datapro-aa7d04314c872cd0_bg.js": import0,
    };
}
...
async function __wbg_init(module_or_path) {
    ...
    if (module_or_path === undefined) {
        module_or_path = new URL('datapro-aa7d04314c872cd0_bg.wasm', import.meta.url);
    }
    const imports = __wbg_get_imports();
